...
function research(auth, chatId, resp) {
    ...
    sheets.spreadsheets.values.get({
        spreadsheetId: '1GHQSXdiQ-7sHV_tcfUMbjGIRQ4HH5D_bKuDjUPZGYp0', // identifiant du spreadsheet
...
bot.on('callback_query', function onCallbackQuery(callbackQuery) {
    ...
    if (action.id === 4) { // display the search button
        ...
        bot.sendMessage(msg.chat.id, 'Écrivez avec un "/search" devant la phrase que vous écrivez les mots clés que vous voulez faire ressortir ', opts);
